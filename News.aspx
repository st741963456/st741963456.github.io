    ...
    <form id="form1" runat="server">
       ...
       <div class="tm-container">        
        ...
        <div class="container-fluid pt-5">
            <div class="container">
                <div class="row">
                    <asp:GridView ID="customers" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" BackColor="#CCCCCC" ForeColor="Black">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="標題">
                                <ItemTemplate>
                                    ...
                                    <a href='<%# "NewsView.aspx?id=" + Eval("Id").ToString() %>'><%# Eval("title") %></a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="SqlDataSource2" BackColor="#CCCCCC" ForeColor="Black">
                        <Fields>
